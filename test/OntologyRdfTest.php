...
use oat\GenerisSaft\SaftOntology;
...
class OntologyRdfTest extends GenerisTestCase
{
    ...
    {
        return [
            [$this->getSaftOntologyMock()]
        ];
    }
    
    protected function getSaftOntologyMock()
    {
        $ontology = new SaftOntology();
        $this->setupOntology($ontology);
        return $ontology;
    }
}
